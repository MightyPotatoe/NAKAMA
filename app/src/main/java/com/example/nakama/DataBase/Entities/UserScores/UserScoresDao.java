...
public interface UserScoresDao {
    ...
    @Query("update UserScores set attempt_time = :attempt_time, false_alarms = :falseAlarms, treat_drop = :treatDrop, defecation = :defecation, score = :score, overview = :overview where user_id = :userId and difficulty = :difficulty and ring = :ring")
    void updateUserScores(int userId, String difficulty, String ring, String attempt_time, int falseAlarms, int treatDrop, boolean defecation, int score, String overview);
